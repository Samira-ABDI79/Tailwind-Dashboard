...
function ViewComments({showView,
    setShowView,
    comment}){   
        ...
        <div className="relative w-full h-full max-w-2xl md:h-auto">
            ...
            <form  onSubmit={formHandler} action="#" className="relative bg-white rounded-lg shadow ">
                ...
                <div className="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button" onClick={()=>setShowView(false)}  className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center " data-modal-hide="viewCommentsModal">
