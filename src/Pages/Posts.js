...
const [comment , setcomment ] = useState()
  ...
  const view= (id) => {
    axios({
      method: "get",
      url: `http://localhost:3004/posts/${id}`,
      params: {
          _limit: 5
      }
    })
         ...
         <div className="relative overflow-x-auto  ">
             <div className="flex items-center justify-between py-4 bg-white ">
                 ...
                 <div className="relative">
                     ...
                     <input type="text" id="table-search-posts" className="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for posts"/>
                 </div>
             </div>
         ...
         <tr className="bg-white border-b  dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                         ...
                         <td className="px-6 py-4">
                             ...
                             <a href="#" onClick={()=>handleEdit(comment,comment.id)}
                              ...
                              type="button" data-modal-target="editcommentModal" data-modal-show="editcommentModal" className="font-medium text-blue-600  hover:underline">Edit post</a>
                         </td>
